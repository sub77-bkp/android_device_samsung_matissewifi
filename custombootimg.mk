...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(MKBOOTIMG) --kernel $(KER) --ramdisk $(LZMA_RAMDSK) --cmdline "console=null androidboot.console=null androidboot.hardware=qcom user_debug=23 msm_rtb.filter=0x37 androidboot.bootdevice=msm_sdcc.1" --base 0x00000000 --pagesize 2048 --ramdisk_offset 0x02000000 --dt $(DTB) --tags_offset 0x01e00000 --output $(PRODUCT_OUT)/recovery.img
